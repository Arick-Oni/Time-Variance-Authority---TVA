...
<head>
	...
	<style>
		...
		.navbar {
			...
			/* background-image: linear-gradient(to right, rgba(200, 200, 200, 0.5), rgba(255, 255,255, 0)); */
			margin-right: 50px;
			margin-left: 50px;
			margin-top: 0px;
			border: 1px;
...
<body>
		<div class="video">
            <video autoplay loop muted playsinline>
                <source src="../assets/videos/optimized/video_optimized.mp4" type="video/mp4">
